...
//typedef std::vector<std::vector<VertexViewInfo> > VertexViewInfos;
typedef acc::BVHTree<unsigned int, math::Vec3f> BVHTree;
//typedef std::vector<Face_Project_Info> Face_Project_Infos;
/**
...
build_model(mve::TriangleMesh::ConstPtr mesh,
    TextureAtlases const & texture_atlas, Model * model, bool bFlg);
