...
Arguments parse_args(int argc, char **argv) {
	...
	//args.add_option('ir', "number of iteration", true, "input iterations");
	...
	//conf.iteration = std::stoi(args.get_nth_nonopt(3));//08/07/2017
	//conf.patch_size = std::stoi(args.get_nth_nonopt(4));//08/21/2017
	//conf.min_res = std::stoi(args.get_nth_nonopt(5));//08/21/2017
